package com.sisternav.myappointments.io.fcm
...
import com.sisternav.myappointments.ui.MainActivity
...
class FCMService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        remoteMessage.notification?.let {
            ...
            if(body != null){
                ...
                //Si el mensaje llego y el app estaba abierto no llega la notificación, pero si deseamos que llegue aun el app este abierto
                //debemos habilitar el siguiente metodo
    ...
    override fun onNewToken(newToken: String) {
        ...
        val call = apiService.postToken("Bearer $jwt", newToken)
